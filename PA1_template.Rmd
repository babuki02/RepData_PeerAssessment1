...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <link rel="web-socket" href="wss://live.github.com/_sockets/MTIwMTk1Mzg6NWY5N2YyYjE0MDk2YjdhNTI4YTk4N2YzMzNhNzZhZjg6MjliM2QyNTM5NTZmNzYzMjg0MTc0YTIzYmFkYjg3NmE3ZmNhYmRkNzllYmRjZGQ4YWEzZTk4YjI2NGY4MTBmNQ==--981883fdf4f39caaef80f82e2ba535270e41ddf4">
...
<meta content="collector.githubapp.com" name="octolytics-host"><meta content="github" name="octolytics-app-id"><meta content="B6412BA1:5928:29DC9DD8:5648BA52" name="octolytics-dimension-request_id"><meta content="12019538" name="octolytics-actor-id"><meta content="babuki02" name="octolytics-actor-login"><meta content="24cffcf466a9fc8098fe6572127af18692f7a7c83bc1de3607e6d95628cc5eca" name="octolytics-actor-hash">
...
<meta content="Rails, view, blob#show" data-pjax-transient="true" name="analytics-event">
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="user-login" content="babuki02">

      <link rel="mask-icon" href="https://assets-cdn.github.com/pinned-octocat.svg" color="#4078c0">
      <link rel="icon" type="image/x-icon" href="https://assets-cdn.github.com/favicon.ico">

    <meta content="dd83cbdf9541db3fc3795cbb2298808288410ef6" name="form-nonce">

    <link crossorigin="anonymous" href="PA1_template_files/github-6670887f84dea33391b25bf5af0455816ab82a9bec8f4f5e4d816.css" integrity="sha256-ZnCIf4TeozORslv1rwRVgWq4Kpvsj09eTYFg1TsIwPM=" media="all" rel="stylesheet">
    <link crossorigin="anonymous" href="PA1_template_files/github2-53964e9b93636aa437196c028e3b15febd3c6d5a52d4e8368a9c.css" integrity="sha256-U5ZOm5NjaqQ3GWwCjjsV/r08bVpS1Og2ipwolJMtKU4=" media="all" rel="stylesheet">
  ...
  <span class="mega-octicon octicon-mark-github"></span>
      ...
      <div class="site-search repo-scope js-site-search" role="search">
          <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/sefakilic/coursera-repdata/search" class="js-site-search-form" data-global-search-url="/search" data-repo-search-url="/sefakilic/coursera-repdata/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" value="✓" type="hidden"></div>
  <label class="js-chromeless-input-container form-control">
    <div class="scope-badge">This repository</div>
    <input class="js-site-search-focus js-site-search-field is-clearable chromeless-input" data-hotkey="s" name="q" placeholder="Search" aria-label="Search this repository" data-global-scope-placeholder="Search GitHub" data-repo-scope-placeholder="Search" tabindex="1" autocapitalize="off" type="text">
  </label>
</form>
      </div>
...
<ul class="header-nav user-nav right" id="user-links">
  <li class="header-nav-item">
      <span class="js-socket-channel js-updatable-content" data-channel="notification-changed:babuki02" data-url="/notifications/header">
...
<a class="dropdown-item" href="https://github.com/new" data-ga-click="Header, create new repository">
  ...
  <li class="header-nav-item dropdown js-menu-container">
    <a class="header-nav-link name tooltipped tooltipped-s js-menu-target" href="https://github.com/babuki02" aria-label="View profile and more" data-ga-click="Header, show menu, icon:avatar">
      <img alt="@babuki02" class="avatar" src="PA1_template_files/12019538.png" height="20" width="20">
      <span class="dropdown-caret"></span>
    </a>
    ...
    <div class="dropdown-menu-content js-menu-content">
      <div class="dropdown-menu  dropdown-menu-sw">
        <div class=" dropdown-header header-nav-current-user css-truncate">
            Signed in as <strong class="css-truncate-target">babuki02</strong>
        ...
        <div class="dropdown-divider"></div>
          ...
          <a class="dropdown-item" href="https://github.com/babuki02" data-ga-click="Header, go to profile, text:your profile">
            Your profile
          </a>
        ...
        <a class="dropdown-item" href="https://help.github.com/" data-ga-click="Header, go to help, text:help">
          ...
          <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/logout" class="logout-form" data-form-nonce="dd83cbdf9541db3fc3795cbb2298808288410ef6" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" value="✓" type="hidden"><input name="authenticity_token" value="aKTRXRKfxNO2qw7RUR1WwSzBKAx8m1zh4JpwN2VZOC1aO/z0B9HGGaZ/et/RS4GnnmMxKsnvEfxQm8TdxfBt8g==" type="hidden"></div>
...
<ul class="pagehead-actions">
  ...
  <li>
        <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-form-nonce="dd83cbdf9541db3fc3795cbb2298808288410ef6" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" value="✓" type="hidden"><input name="authenticity_token" value="C1GOa3+8Qclm+8IYL0kOyABKO1sey6n13T+1+EP/WCHsuAjlPknvja1J5R/Gj6cWgzAxUqTbnmM9krBa37ey3A==" type="hidden"></div>      <input id="repository_id" name="repository_id" value="19899531" type="hidden">

        <div class="select-menu js-menu-container js-select-menu">
          <a href="https://github.com/sefakilic/coursera-repdata/subscription" class="btn btn-sm btn-with-count select-menu-button js-menu-target" role="button" tabindex="0" aria-haspopup="true" data-ga-click="Repository, click Watch settings, action:blob#show">
            <span class="js-select-button">
              <span class="octicon octicon-eye"></span>
              Watch
            </span>
          </a>
          <a class="social-count js-social-count" href="https://github.com/sefakilic/coursera-repdata/watchers">
            3
          </a>
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/sefakilic/coursera-repdata/unstar" class="js-toggler-form starred js-unstar-button" data-form-nonce="dd83cbdf9541db3fc3795cbb2298808288410ef6" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" value="✓" type="hidden"><input name="authenticity_token" value="0UcvPt9cQBbgR1zZamFj2KTsC9Od1A+/Ic4FSp18usAmeollwO16hq0Y22XdSbRAkAJGDOTwtfwuxyRkz4wWlg==" type="hidden"></div>
      <button class="btn btn-sm btn-with-count js-toggler-target" aria-label="Unstar this repository" title="Unstar sefakilic/coursera-repdata" data-ga-click="Repository, click unstar button, action:blob#show; text:Unstar">
        <span class="octicon octicon-star"></span>
        Unstar
      </button>
        <a class="social-count js-social-count" href="https://github.com/sefakilic/coursera-repdata/stargazers">
          2
        </a>
</form>
    <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/sefakilic/coursera-repdata/star" class="js-toggler-form unstarred js-star-button" data-form-nonce="dd83cbdf9541db3fc3795cbb2298808288410ef6" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" value="✓" type="hidden"><input name="authenticity_token" value="SUCi2NhQxxPjgD3/TX/QvUzua46de5NPYql97rZaQxJSg7xI5k1PIl7oD9Ku/VUv26WD2YoDLSRdtPpGd/X+kQ==" type="hidden"></div>
      <button class="btn btn-sm btn-with-count js-toggler-target" aria-label="Star this repository" title="Star sefakilic/coursera-repdata" data-ga-click="Repository, click star button, action:blob#show; text:Star">
        <span class="octicon octicon-star"></span>
        Star
      </button>
        <a class="social-count js-social-count" href="https://github.com/sefakilic/coursera-repdata/stargazers">
  ...
  <li>
          <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/sefakilic/coursera-repdata/fork" class="btn-with-count" data-form-nonce="dd83cbdf9541db3fc3795cbb2298808288410ef6" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" value="✓" type="hidden"><input name="authenticity_token" value="wS21yDSxcLouBRnbRSgdDJNw2b1OojsLWZd8yv4cCt1SitMiQexhbycOILLCQrK2qrjhzjpRRwtj7+Ks9Netjw==" type="hidden"></div>
            <button type="submit" class="btn btn-sm btn-with-count" data-ga-click="Repository, show fork modal, action:blob#show; text:Fork" title="Fork your own copy of sefakilic/coursera-repdata to your account" aria-label="Fork your own copy of sefakilic/coursera-repdata to your account">
              <span class="octicon octicon-repo-forked"></span>
              Fork
            </button>
</form>
    <a href="https://github.com/sefakilic/coursera-repdata/network" class="social-count">
      20,163
    </a>
  </li>
</ul>
  ...
  <span class="author"><a href="https://github.com/sefakilic" class="url fn" itemprop="url" rel="author"><span itemprop="title">sefakilic</span></a></span><!--
--><span class="path-divider">/</span><!--
--><strong><a href="https://github.com/sefakilic/coursera-repdata" data-pjax="#js-repo-pjax-container">coursera-repdata</a></strong>

  <span class="page-context-loader">
    <img alt="" src="PA1_template_files/octocat-spinner-32.gif" height="16" width="16">
  </span>

    <span class="fork-flag">
      <span class="text">forked from <a href="https://github.com/rdpeng/RepData_PeerAssessment1">rdpeng/RepData_PeerAssessment1</a></span>
    </span>
</h1>
...
<nav class="sunken-menu repo-nav js-repo-nav js-sidenav-container-pjax js-octicon-loaders" role="navigation" data-pjax="#js-repo-pjax-container" data-issue-count-url="/sefakilic/coursera-repdata/issues/counts">
  <ul class="sunken-menu-group">
    <li class="tooltipped tooltipped-w" aria-label="Code">
      <a href="https://github.com/sefakilic/coursera-repdata" aria-label="Code" aria-selected="true" class="js-selected-navigation-item selected sunken-menu-item" data-hotkey="g c" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches /sefakilic/coursera-repdata">
        <span class="octicon octicon-code"></span> <span class="full-word">Code</span>
        <img alt="" class="mini-loader" src="PA1_template_files/octocat-spinner-32.gif" height="16" width="16">
</a>    </li>


    <li class="tooltipped tooltipped-w" aria-label="Pull requests">
      <a href="https://github.com/sefakilic/coursera-repdata/pulls" aria-label="Pull requests" class="js-selected-navigation-item sunken-menu-item" data-hotkey="g p" data-selected-links="repo_pulls /sefakilic/coursera-repdata/pulls">
      ...
      <li class="tooltipped tooltipped-w" aria-label="Wiki">
        <a href="https://github.com/sefakilic/coursera-repdata/wiki" aria-label="Wiki" class="js-selected-navigation-item sunken-menu-item" data-hotkey="g w" data-selected-links="repo_wiki /sefakilic/coursera-repdata/wiki">
  ...
  <ul class="sunken-menu-group">
    ...
    <li class="tooltipped tooltipped-w" aria-label="Pulse">
      <a href="https://github.com/sefakilic/coursera-repdata/pulse" aria-label="Pulse" class="js-selected-navigation-item sunken-menu-item" data-selected-links="pulse /sefakilic/coursera-repdata/pulse">
        <span class="octicon octicon-pulse"></span> <span class="full-word">Pulse</span>
        <img alt="" class="mini-loader" src="PA1_template_files/octocat-spinner-32.gif" height="16" width="16">
</a>    </li>

    <li class="tooltipped tooltipped-w" aria-label="Graphs">
      <a href="https://github.com/sefakilic/coursera-repdata/graphs" aria-label="Graphs" class="js-selected-navigation-item sunken-menu-item" data-selected-links="repo_graphs repo_contributors /sefakilic/coursera-repdata/graphs">
...
<div class="js-clone-url clone-url open" data-protocol-type="http">
  ...
  <div class="input-group js-zeroclipboard-container">
    <input class="input-mini text-small text-muted input-monospace js-url-field js-zeroclipboard-target" value="https://github.com/sefakilic/coursera-repdata.git" readonly="readonly" aria-label="HTTPS clone URL" type="text">
...
<div class="js-clone-url clone-url " data-protocol-type="ssh">
  ...
  <div class="input-group js-zeroclipboard-container">
    <input class="input-mini text-small text-muted input-monospace js-url-field js-zeroclipboard-target" value="git@github.com:sefakilic/coursera-repdata.git" readonly="readonly" aria-label="SSH clone URL" type="text">
    <span class="input-group-button">
      <button aria-label="Copy to clipboard" class="js-zeroclipboard btn btn-sm zeroclipboard-button tooltipped tooltipped-s" data-copied-hint="Copied!" type="button"><span class="octicon octicon-clippy"></span></button>
    </span>
  </div>
...
<div class="js-clone-url clone-url " data-protocol-type="subversion">
  ...
  <div class="input-group js-zeroclipboard-container">
    <input class="input-mini text-small text-muted input-monospace js-url-field js-zeroclipboard-target" value="https://github.com/sefakilic/coursera-repdata" readonly="readonly" aria-label="Subversion checkout URL" type="text">
    <span class="input-group-button">
      <button aria-label="Copy to clipboard" class="js-zeroclipboard btn btn-sm zeroclipboard-button tooltipped tooltipped-s" data-copied-hint="Copied!" type="button"><span class="octicon octicon-clippy"></span></button>
    </span>
  </div>
...
<div class="clone-options text-small text-muted">You can clone with
  <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=http&amp;protocol_type=clone" class="inline-form js-clone-selector-form is-enabled" data-form-nonce="dd83cbdf9541db3fc3795cbb2298808288410ef6" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" value="✓" type="hidden"><input name="authenticity_token" value="WwXLooc8ooQis7Ve3HrXAC4j8sYoX0ez+CexeEZJHYzPGiwxOj3vLQHpCImUdPeek9jCZGZBPm89qMCyGn+yKw==" type="hidden"></div><button class="btn-link js-clone-selector" data-protocol="http" type="submit">HTTPS</button></form>, <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=ssh&amp;protocol_type=clone" class="inline-form js-clone-selector-form is-enabled" data-form-nonce="dd83cbdf9541db3fc3795cbb2298808288410ef6" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" value="✓" type="hidden"><input name="authenticity_token" value="3YZvch3MEVjw4NjVremstX2blD0hOqpiDi+3GAsru0o3jwc3MEVqVqXd/BPreg1Nk0sgLgD04h6G9g8tnmgUTw==" type="hidden"></div><button class="btn-link js-clone-selector" data-protocol="ssh" type="submit">SSH</button></form>, or <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=subversion&amp;protocol_type=clone" class="inline-form js-clone-selector-form is-enabled" data-form-nonce="dd83cbdf9541db3fc3795cbb2298808288410ef6" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" value="✓" type="hidden"><input name="authenticity_token" value="dUjJBMj6a+FBoQPDZbdeyhP4gzrzzkUqBJ6qxtNi3OkHrLwP5nC7G1/KaPe+4T39vkdtMm6CIef7iNRV5DfRww==" type="hidden"></div><button class="btn-link js-clone-selector" data-protocol="subversion" type="submit">Subversion</button></form>.
  ...
  <a href="github-windows://openRepo/https://github.com/sefakilic/coursera-repdata" class="btn btn-sm sidebar-button" title="Save sefakilic/coursera-repdata to your computer and use it in GitHub Desktop." aria-label="Save sefakilic/coursera-repdata to your computer and use it in GitHub Desktop.">
    ...
    Clone in Desktop
              ...
              <a href="https://github.com/sefakilic/coursera-repdata/archive/master.zip" class="btn btn-sm sidebar-button" aria-label="Download the contents of sefakilic/coursera-repdata as a zip file" title="Download the contents of sefakilic/coursera-repdata as a zip file" rel="nofollow">
...
<a href="https://github.com/sefakilic/coursera-repdata/blob/887120ed7a37211dd2d2bdc05dbe0e81e0e1ae7d/project1/PA1_template.Rmd" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>
...
<div class="select-menu js-menu-container js-select-menu left">
  ...
  <div class="select-menu-modal-holder js-menu-content js-navigation-container" data-pjax="" aria-hidden="true">
    ...
    <div class="select-menu-modal">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected" href="https://github.com/sefakilic/coursera-repdata/blob/master/project1/PA1_template.Rmd" data-name="master" data-skip-pjax="true" rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
    ...
    <div class="btn-group right">
      <a href="https://github.com/sefakilic/coursera-repdata/find/master" class="js-show-file-finder btn btn-sm empty-icon tooltipped tooltipped-nw" data-pjax="" data-hotkey="t" aria-label="Quickly jump between files">
    ...
    <div class="breadcrumb js-zeroclipboard-target">
      <span class="repo-root js-repo-root"><span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="https://github.com/sefakilic/coursera-repdata" class="" data-branch="master" data-pjax="true" itemscope="url"><span itemprop="title">coursera-repdata</span></a></span></span><span class="separator">/</span><span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="https://github.com/sefakilic/coursera-repdata/tree/master/project1" class="" data-branch="master" data-pjax="true" itemscope="url"><span itemprop="title">project1</span></a></span><span class="separator">/</span><strong class="final-path">PA1_template.Rmd</strong>
    </div>
  </div>
  ...
  <div class="commit-tease">
      <span class="right">
        <a class="commit-tease-sha" href="https://github.com/sefakilic/coursera-repdata/commit/a294c1c2856357eb6f345902dd359b0814b386b0" data-pjax="">
          a294c1c
        </a>
        <time title="18 May 2014, 8:35 PM IST" datetime="2014-05-18T15:05:57Z" is="relative-time">on 18 May 2014</time>
      </span>
      <div>
        <img alt="@sefakilic" class="avatar" src="PA1_template_files/1227083.jpg" height="20" width="20">
        <a href="https://github.com/sefakilic" class="user-mention" rel="author">sefakilic</a>
          <a href="https://github.com/sefakilic/coursera-repdata/commit/a294c1c2856357eb6f345902dd359b0814b386b0" class="message" data-pjax="true" title="peer assessment 1">peer assessment 1</a>
      </div>
    ...
    <div id="blob_contributors_box" style="display:none">
      ...
      <ul class="facebox-user-list" data-facebox-id="facebox-description">
          <li class="facebox-user-list-item">
            <img alt="@sefakilic" src="PA1_template_files/1227083_002.jpg" height="24" width="24">
            <a href="https://github.com/sefakilic">sefakilic</a>
          </li>
      </ul>
    </div>
  </div>
...
<div class="file">
  ...
  <div class="file-actions">
    ...
    <div class="btn-group">
      <a href="https://github.com/sefakilic/coursera-repdata/raw/master/project1/PA1_template.Rmd" class="btn btn-sm " id="raw-url">Raw</a>
        <a href="https://github.com/sefakilic/coursera-repdata/blame/master/project1/PA1_template.Rmd" class="btn btn-sm js-update-url-with-hash">Blame</a>
      <a href="https://github.com/sefakilic/coursera-repdata/commits/master/project1/PA1_template.Rmd" class="btn btn-sm " rel="nofollow">History</a>
    </div>

        <a class="octicon-btn tooltipped tooltipped-nw" href="github-windows://openRepo/https://github.com/sefakilic/coursera-repdata?branch=master&amp;filepath=project1%2FPA1_template.Rmd" aria-label="Open this file in GitHub Desktop" data-ga-click="Repository, open with desktop, type:windows">
            <span class="octicon octicon-device-desktop"></span>
        </a>

        <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/sefakilic/coursera-repdata/edit/master/project1/PA1_template.Rmd" class="inline-form js-update-url-with-hash" data-form-nonce="dd83cbdf9541db3fc3795cbb2298808288410ef6" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" value="✓" type="hidden"><input name="authenticity_token" value="tHo4taY7yEyUV10/rWqCBlfmfHKWXIr+Qx1DWGW1uJPy4cChaKkaI7N7A3hmKjzCLPL2oPfDtj4vYNGA26iHaA==" type="hidden"></div>
          <button class="octicon-btn tooltipped tooltipped-nw" type="submit" aria-label="Edit the file in your fork of this project" data-hotkey="e" data-disable-with="">
            <span class="octicon octicon-pencil"></span>
          </button>
</form>        <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/sefakilic/coursera-repdata/delete/master/project1/PA1_template.Rmd" class="inline-form" data-form-nonce="dd83cbdf9541db3fc3795cbb2298808288410ef6" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" value="✓" type="hidden"><input name="authenticity_token" value="67tKeOhO8+apSbqY/mkLbAxTz/52hnXmUJQ1hPMbVKsMkn6VN6L5dhcHuk+jQlEUTr9pHpYelTX2YUZ0buznjA==" type="hidden"></div>
          <button class="octicon-btn octicon-btn-danger tooltipped tooltipped-nw" type="submit" aria-label="Delete the file in your fork of this project" data-disable-with="">
...
<p>Now, using the filled data set, let's make a histogram of the total 
...
<div id="jump-to-line" style="display:none">
  <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="" class="js-jump-to-line-form" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" value="✓" type="hidden"></div>
    <input class="linejump-input js-jump-to-line-field" placeholder="Jump to line…" aria-label="Jump to line" autofocus="" type="text">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>© 2015 <span title="0.07217s from github-fe135-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
    ...
    <div id="ajax-error-message" class="flash flash-error">
      ...
      <script crossorigin="anonymous" integrity="sha256-Ln/D0mSiCOE4PehbgVN5vsz/VsH5d3FFFdTKx4IO7z4=" src="PA1_template_files/frameworks-2e7fc3d264a208e1383de85b815379beccff56c1f977714515.js"></script>
      <script async="async" crossorigin="anonymous" integrity="sha256-rTr6IWawEoCoreiImpp96o7JQo1iyJKyFkVrNelXTcw=" src="PA1_template_files/github-ad3afa2166b01280a8ade8889a9a7dea8ec9428d62c892b216456b.js"></script>
